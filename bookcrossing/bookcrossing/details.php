...
if (isset($_POST['deactivate'])) {
    $sql = 'UPDATE ads SET date_deact = NOW() WHERE id = ?';
        ...
        <div class="book-details">
            <div class="book-info">
                ...
                <div class="button-container">
                    <a href="library.php" class="back-button">Назад до оголошень</a>
                    <form action="details.php?ad_id=<?php echo $ad_id; ?>" method="POST">
                        <button type="submit" name="deactivate" class="deactivate-button">Деактивувати книгу</button>
                    </form>
                </div>
            </div>
